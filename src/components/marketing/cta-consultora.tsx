        ...
        <Container className="py-20">
            <div className="bg-background border rounded-lg p-8 md:p-12">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div>
                        <h2 className="text-3xl md:text-4xl font-bold text-foreground">Acelere sua carreira com tecnologia</h2>
                    ...
                    <div className="text-center md:text-right">
                        ...
                        <Link href="http://redefigital-frontend.onrender.com/sign-up">
