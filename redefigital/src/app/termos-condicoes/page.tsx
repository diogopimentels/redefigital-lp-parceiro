                ...
                <Container>
                    <div className="max-w-4xl mx-auto prose prose-slate dark:prose-invert">
                        ...
                        <section className="mb-12">
                            ...
                            <p className="mb-4">
                                A plataforma caracteriza-se pela prestação do serviço de aproximação entre os fabricantes e fornecedores de produtos, os consultores de vendas e os comerciantes dos produtos.
                            </p>
                            <p className="mb-4">
